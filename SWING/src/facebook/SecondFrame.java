...
public class SecondFrame {
	...
	String columName[] = { "firstName", "surname", "email", "reEnteredEmail", "newPassword", "Birthady", "Age" };
	...
	public SecondFrame(String[] str) {
		...
		JLabel firstName, surname, email, reEnteredEmail, newPassword, gender, birthday, age;
...
//				for (int i = 0; i < arr.size(); i++) {
//					
//					System.out.println("First name is  " + information[i][0] + ", " + "surname is  " + information[i][1]
//							+ ", " + "new email is  " + information[i][2] + ", " + "re-entered email is  "
//							+ information[i][3] + ", " + "password is " + information[i][4] + ", " + "Birthday is  "
//							+ information[i][5] + ", " + "Age is : " + information[i][6]);
//
//				}
