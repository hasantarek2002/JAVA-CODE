...
public class Information {
	private String firstName, surName, email, reEnteredEmail, newPassword, birthday, age;
	...
	public String toString() {
		return "Information [firstName=" + firstName + ", surName=" + surName + ", email=" + email + ", reEnteredEmail="
				+ reEnteredEmail + ", newPassword=" + newPassword + ", birthday=" + birthday + ", age=" + age + "]";
	}
